describe("VGR schválí a přidá komentář", () => {
  it("should fill form and submit successfully", () => {
    ...
    // Klikneme na přidat
    cy.contains(".text-h6", "MSBase s finanční podporou") // možnosti: Centrum Žadatele, Více Center, MS Base, MS Base - Retrospektivní, MS Base - Prospektivní, MS Base s finanční podporou
